...
function SignIn(){
    return(
        <form className='form'>
            <InputField for="mail" id="mail" placeholder="Email" name="mail" type="email" icon={faEnvelope} title="Email"/>
            <InputField for="password" id="password" placeholder="Password" name="password" type="password" icon ={faLock} title="Password" />
